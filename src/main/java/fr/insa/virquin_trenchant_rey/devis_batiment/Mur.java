...
public class Mur {
    ...
    public static void creerMur(){
        System.out.println(DvBat1.ListCoin);
        ...
        if(Verification.possibleMur(c1,c2)){
            ...
            Mur m = new Mur (c1, c2, Objfromid.NiveauFromId(DvBat1.niv_actu), ListPorte, ListFenetre, DvBat1.idm, null);
            DvBat1.ListMur.add(m);
    ...
    public static void ajoutPorte(int id){ // permet d'ajouter une porte dans un mur si on crere une porte dans un autre mur 
            ...
            if (m.getDebut().getX() == m.getFin().getX()){ // si le mur m est vertical
                ...
                if(Objfromid.MurFromPorteId(id).getDebut().getX() == Objfromid.MurFromPorteId(id).getFin().getX()){
                    ...
                    if(Objfromid.MurFromPorteId(id).getDebut().getY() == m.getFin().getX()){
                        ...
                        //si les coordonne projeté de la porte sont sur le mur
